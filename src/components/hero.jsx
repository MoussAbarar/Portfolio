    ...
    return(
        <section id='home' className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 text-black dark:text-white px-4">
            ...
            >
                ...
                <p className='text-gray-600 dark:text-gray-300 max-w-xl mx-auto mb-6'>I love turning ideas into interactive websites using React, TailwindCSS, and PHP. Clean code, smooth design, and great user experience are my goals.</p>
                <div className='flex flex-col justify-center sm:flex-row gap-4'>
                    <Link to='contact' smooth={true} duration={500} className='cursor-pointer inline-block bg-blue-600 border-blue-600 dark:border-gray-900 border-2 dark:border-blue-500 dark:bg-blue-500 text-white dark:hover:bg-blue-400 px-6 py-3 rounded-3xl hover:bg-blue-700 transition w-fit sm:mx-0 mx-auto sm:w-1/3'>Contact Me</Link>
